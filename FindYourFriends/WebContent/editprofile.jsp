...
<%
	...
	if (UserDetails != null) {
		...
		java.sql.Date d1 = (java.sql.Date) UserDetails.get("dob");
		java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd/MM/yyyy");
		String sd=sdf.format(d1);
		/* String cDate = d1.toString();
		StringBuffer dob1= new StringBuffer("");
							...
							<form action="ChangePhoto" method='post'
								...
								<div class="col-lg-2 col-lg-offset-1">
									<%
										db.DbConnection db = (db.DbConnection) session.getAttribute("db");
											...
											if (photo.length != 0) {
									%>
									<img src='GetPhoto.jsp?email=<%=UserDetails.get("email")%>'
								...
								<div class="col-lg-2">
									<div class="form-group">
										...
										</br> <label for="changephoto" class="control-label">Change
											Photo:</label><br>
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
										...
										</br> <input type="file" name="photo" class="form-control"
											id="changephoto" required />
									</div>
								</div>
								<div class="col-lg-3 ">
									<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name='phone'
										value="<%=UserDetails.get("phone")%>" class="form-control"
										pattern="^[_0-9]{1,}$" maxlength="10" minlength="10"
										id="phone" placeholder="<%=UserDetails.get("phone")%>"
										required />
								</div>
							</div>
							<!--end form group-->
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" class="form-control" id="name" name="name"
										...
										pattern="^[_A-Z a-z]{1,}$"
										placeholder="<%=UserDetails.get("name")%>" required />
								</div>
							</div>
							<!--end form group-->
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<%-- <input type="text" name="dob" class="form-control" id="dob"
										value='<%=al.get(2)%>/<%=al.get(1)%>/<%=al.get(0)%>'
										placeholder="<%=al.get(2)%>/<%=al.get(1)%>/<%=al.get(0)%>" /> --%>
										<input type="text" name="dob" class="form-control" id="dob"
										value='<%=sd%>'
										placeholder="<%=sd%>" />
								</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" class="form-control" id="area" name="area"
										value='<%=UserDetails.get("area")%>'
										placeholder="<%=UserDetails.get("area")%>" required />
								</div>
							</div>
							<!--end form group-->
							<div class="form-group">
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom">
		<div class="container">
			<div class="navbar-text pull-left">
				<h4>Developed by: Mukul Samrat & Mentor: Mr. Rahul Chauhan,
					Director, INCAPP INFOTECH PVT LTD.</h4>
			</div>
		</div>
	</div>
